...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const login = async (identifier: string, password: string, role: string): Promise<boolean> => {
    try {
      ...
      const mockUsers = [
        { id: '1', name: 'Sridhar', email: 'sridhar@oxford.edu', role: 'student', department: 'Computer Science Engineering with AI', avatar: 'https://images.pexels.com/photos/1438081/pexels-photo-1438081.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&fit=crop', phone: '+91 9876543210', address: '123 Main St, Hyderabad', joinDate: '2023-08-01', rollNumber: 'CS2023001' },
        { id: '2', name: 'Sai', email: 'sai@oxford.edu', role: 'student', department: 'Artificial Intelligence & Machine Learning', avatar: 'https://images.pexels.com/photos/1181686/pexels-photo-1181686.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&fit=crop', phone: '+91 9876543211', address: '456 Oak Ave, Hyderabad', joinDate: '2023-08-01', rollNumber: 'AI2023002' },
        { id: '3', name: 'Santhosh', email: 'santhosh@oxford.edu', role: 'student', department: 'Computer Science Engineering', avatar: 'https://images.pexels.com/photos/1222271/pexels-photo-1222271.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&fit=crop', phone: '+91 9876543212', address: '789 Pine St, Hyderabad', joinDate: '2023-08-01', rollNumber: 'CS2023003' },
        { id: '4', name: 'Sandeep', email: 'sandeep@oxford.edu', role: 'student', department: 'Machine Learning Engineering', avatar: 'https://images.pexels.com/photos/1181424/pexels-photo-1181424.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&fit=crop', phone: '+91 9876543213', address: '321 Elm St, Hyderabad', joinDate: '2023-08-01', rollNumber: 'ML2023004' },
