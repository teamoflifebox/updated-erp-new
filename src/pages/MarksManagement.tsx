...
const MarksManagement: React.FC = () => {
  ...
  const saveMarks = async () => {
    console.log('Saving marks for', selectedExam, selectedSubject);
    console.log('Marks data:', studentMarks);
    
    // Send notifications to all parents if auto-notify is enabled
    if (autoNotify) {
          ...
          <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-xl p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Your parents receive automatic notifications when new marks are published</p>
              </div>
            </div>
          </div>
      ...
      >
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600">Upload marks and automatically notify parents via WhatsApp</p>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Automatically notify parents when marks are published or updated</p>
              </div>
            </div>
                      ...
                      <td className="py-3 px-4 text-center">
                        {isEditing ? (
                          <input
                            ...
                            className="w-20 px-2 py-1 border border-gray-300 rounded text-center focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                          />
                        ) : (
