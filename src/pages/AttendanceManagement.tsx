...
const AttendanceManagement: React.FC = () => {
  ...
  const handleAttendanceChange = async (studentId: string, status: string) => {
    ...
    // Auto-notify parents if enabled and status changed to absent
  ...
  const saveAttendance = async () => {
    console.log('Saving attendance for', selectedDate, selectedClass, selectedSubject);
    console.log('Attendance data:', studentAttendance);
    
    // Send bulk notifications for all absent students
    if (autoNotify) {
