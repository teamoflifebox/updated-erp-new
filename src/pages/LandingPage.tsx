...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-[#1E3A8A] text-white py-2 px-4 text-center text-sm font-medium">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <button onClick={() => scrollToSection('about')} className="text-gray-700 hover:text-[#1E3A8A] transition-colors">About</button>
              <button onClick={() => scrollToSection('courses')} className="text-gray-700 hover:text-[#1E3A8A] transition-colors">Courses</button>
              <button onClick={() => scrollToSection('events')} className="text-gray-700 hover:text-[#1E3A8A] transition-colors">Events</button>
              <button onClick={() => scrollToSection('placements')} className="text-gray-700 hover:text-[#1E3A8A] transition-colors">Placements</button>
              <button onClick={() => scrollToSection('contact')} className="text-gray-700 hover:text-[#1E3A8A] transition-colors">Contact</button>
              <button 
                onClick={() => setIsLoggedIn(true)}
                className="bg-[#1E3A8A] text-white px-4 py-2 rounded-lg hover:bg-[#1E3A8A]/90 transition-colors"
              >
                Login
              </button>
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <button onClick={() => scrollToSection('about')} className="block w-full text-left px-3 py-2 text-gray-700 hover:text-[#1E3A8A] transition-colors">About</button>
              <button onClick={() => scrollToSection('courses')} className="block w-full text-left px-3 py-2 text-gray-700 hover:text-[#1E3A8A] transition-colors">Courses</button>
              <button onClick={() => scrollToSection('events')} className="block w-full text-left px-3 py-2 text-gray-700 hover:text-[#1E3A8A] transition-colors">Events</button>
              <button onClick={() => scrollToSection('placements')} className="block w-full text-left px-3 py-2 text-gray-700 hover:text-[#1E3A8A] transition-colors">Placements</button>
              <button onClick={() => scrollToSection('contact')} className="block w-full text-left px-3 py-2 text-gray-700 hover:text-[#1E3A8A] transition-colors">Contact</button>
              <button 
                onClick={() => setIsLoggedIn(true)}
                className="block w-full text-left px-3 py-2 bg-[#1E3A8A] text-white rounded-lg hover:bg-[#1E3A8A]/90 transition-colors"
              >
                Login
              </button>
            </div>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#1E3A8A] to-[#9333EA]">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-[#1E3A8A] text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[#1E3A8A]/90 transform hover:scale-105 transition-all duration-300 shadow-lg">
              Apply Now
            </button>
            <button className="bg-white text-[#1E3A8A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg">
              Explore Programs
            </button>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  <div className="bg-[#1E3A8A]/10 rounded-full p-4 w-16 h-16 flex items-center justify-center mx-auto mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {courses.map((course, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 border border-gray-100 hover:border-[#1E3A8A]/20 group">
                <div className="bg-[#1E3A8A]/10 rounded-full p-4 w-16 h-16 flex items-center justify-center mb-6 group-hover:bg-[#1E3A8A]/20 transition-colors">
                ...
                <button className="text-[#1E3A8A] font-semibold hover:text-[#1E3A8A]/90 transition-colors flex items-center gap-2">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {events.map((event, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 border border-gray-100">
                ...
                <button className="bg-[#1E3A8A] text-white px-6 py-3 rounded-lg hover:bg-[#1E3A8A]/90 transition-colors">
                  Register Now
                </button>
              </div>
            ))}
      ...
      <section id="placements" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center">
              <div className="bg-[#1E3A8A]/10 rounded-full p-6 w-24 h-24 flex items-center justify-center mx-auto mb-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {faculty.map((member, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 text-center">
                ...
                <p className="text-[#1E3A8A] font-semibold mb-2">{member.subject}</p>
            ...
            <div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <form className="space-y-4">
                  ...
                  <button className="w-full bg-[#1E3A8A] text-white py-3 px-6 rounded-lg hover:bg-[#1E3A8A]/90 transition-colors">
                    Send Message
                  </button>
                </form>
              </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <div className="flex space-x-4">
                <Facebook className="w-6 h-6 text-gray-400 hover:text-[#1E3A8A] cursor-pointer transition-colors" />
                <Instagram className="w-6 h-6 text-gray-400 hover:text-[#1E3A8A] cursor-pointer transition-colors" />
                <Linkedin className="w-6 h-6 text-gray-400 hover:text-[#1E3A8A] cursor-pointer transition-colors" />
                <Youtube className="w-6 h-6 text-gray-400 hover:text-[#1E3A8A] cursor-pointer transition-colors" />
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-[#1E3A8A] transition-colors">About Us</a></li>
                <li><a href="#" className="hover:text-[#1E3A8A] transition-colors">Courses</a></li>
                <li><a href="#" className="hover:text-[#1E3A8A] transition-colors">Admissions</a></li>
                <li><a href="#" className="hover:text-[#1E3A8A] transition-colors">Events</a></li>
                <li><a href="#" className="hover:text-[#1E3A8A] transition-colors">Alumni</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-[#1E3A8A] transition-colors">Undergraduate</a></li>
                <li><a href="#" className="hover:text-[#1E3A8A] transition-colors">Postgraduate</a></li>
                <li><a href="#" className="hover:text-[#1E3A8A] transition-colors">Research</a></li>
                <li><a href="#" className="hover:text-[#1E3A8A] transition-colors">Library</a></li>
                <li><a href="#" className="hover:text-[#1E3A8A] transition-colors">E-Learning</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-[#1E3A8A] transition-colors">Student Portal</a></li>
                <li><a href="#" className="hover:text-[#1E3A8A] transition-colors">Faculty Portal</a></li>
                <li><a href="#" className="hover:text-[#1E3A8A] transition-colors">Career Services</a></li>
                <li><a href="#" className="hover:text-[#1E3A8A] transition-colors">Downloads</a></li>
                <li><a href="#" className="hover:text-[#1E3A8A] transition-colors">News</a></li>
              </ul>
            </div>
          </div>
